...
public class Main_Demo {
    ...
    public static void UpdateCountPC() {
        System.out.print("---->Nhap ma phong can c?p nh?t: ");
        sc.nextLine();
        String mp = sc.nextLine();
        int index = 0;
        for(PhongHoc phonghoc : list)
        ...
        while (true) {
            try {
                System.out.print("Nh?p s? máy tính c?a phòng: ");
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("2. Tìm ki?m phòng h?c");
            System.out.println("5. Update s? máy tính");
            System.out.println("6. Xóa phòng h?c");
